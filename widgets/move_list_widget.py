...
class MovesListWidget(QTextBrowser):
    """
    Renders the game moves list/history as click-navigable HTML links with variation support.
    """
...
if __name__ == "__main__":
    app = QApplication([])
    browser = MovesListWidget(None, MoveManager())
    browser.show()
    app.exec_()
