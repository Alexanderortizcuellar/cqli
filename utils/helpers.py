...
def _create_iconed_button(
    icon_name: str, shortcut=str, tooltip: str = "", is_dark=True
) -> QPushButton:
    button = QPushButton()
            ...
            if action.menu():
                ...
                for menu_action in action.menu().actions():
                    if menu_action.property("icon_name"):
                        menu_action.setIcon(
                            _qicon(menu_action.property("icon_name"), is_dark=is_dark)
                        )
