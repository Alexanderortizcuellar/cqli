...
class VariationsDialog(QDialog):
    def __init__(self, variations: dict, parent=None, font_family: str = "Segoe UI"):
        ...
        is_dark = True
        if parent and hasattr(parent, "html_style"):
            is_dark = parent.html_style
        ...
        self.list_widget.setFont(QFont(clean_font, 14))
